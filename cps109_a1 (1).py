...
# Quiz maker and game
# Problem
# This code should allow users to create a quiz consisting of 3 questions in which the user creates the questions, provides some multiple choice options, and the correct answer to each question. The user also can decide the number of players they would like to have play their quiz. 
# Once the quiz is created, each player should be able to take turns answering each question.
